...
public class ArrayOperations {
    public static void main(String[] args) {
        ...
        // Step 3: Sorting Algorithm Choice
        System.out.println("Choose a sorting algorithm:");
        System.out.println("1. Insertion Sort\n2. Selection Sort\n3. Merge Sort\n4. Quick Sort\n5. Bubble Sort");
        int choice = sc.nextInt();

        int[] sortedArray = Arrays.copyOf(array, array.length); // Preserve the original array for sorting
        switch (choice) {
            ...
            case 5: bubbleSort(sortedArray); break;
